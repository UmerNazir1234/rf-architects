...
const SERVICES: Service[] = [
  ...
  { title: "Facade Design", image: "/placeholder.jpg", description: "Expressive facade studies combining materiality, proportion, and lasting street presence." },
  { title: "Construction Drawings", image: "/placeholder.jpg", description: "Coordinated construction details supporting accurate, confident project delivery." },
          ...
          {SERVICES.map((service, index) => (
            ...
            >
              ...
              <div className="flex items-start justify-between gap-4 p-5">
                ...
                <span className="self-start text-xs tracking-widest text-white/40">{String(index + 1).padStart(2, "0")}</span>
              </div>
            </article>
          ))}
        </div>
