            ...
            <main className="pt-0">
                ...
                <section className="relative h-[50vh] min-h-[400px] flex items-center justify-center bg-black text-white overflow-hidden">
                    ...
                    <div className="relative z-10 container mx-auto px-6 text-center">
                        ...
                        >
                            Let's Start a <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-400">Conversation</span>
                        </motion.h1>
                        <motion.p
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                ...
                <section className="py-24 bg-white relative">
                    <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-16 lg:gap-24">
                        ...
                        >
                            <div>
                                <h2 className="text-4xl font-bold mb-6 text-gray-900 tracking-tight">Contact Information</h2>
                                <p className="text-gray-600 text-lg leading-relaxed">
                                    Ready to bring your vision to life? Reach out to us through any of the following channels.
                                </p>
                            </div>

                            <div className="space-y-8">
                                {[
                                    { icon: MapPin, title: "Visit Us", content: ["3rd floor Taha Mall, Defence Rd,", "Rawalpindi, Punjab 47300"] },
                                    { icon: Phone, title: "Call Us", content: ["+92 334 4738506"] },
                                    { icon: Mail, title: "Email Us", content: ["rfarchitects@gmail.com"] },
                                    { icon: Clock, title: "Working Hours", content: ["Mon - Sat: 9:00 AM - 6:00 PM", "Sunday: Closed"] }
                                ].map((item, index) => (
                        ...
                        >
                            <h2 className="text-3xl font-bold mb-8 text-gray-900">Send Message</h2>
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="grid sm:grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        <label htmlFor="name" className="text-sm font-semibold text-gray-700 uppercase tracking-wider">Name</label>
                                        <Input id="name" placeholder="John Doe" required className="bg-white border-gray-200 focus:border-black h-12 rounded-xl transition-all" />
                                    </div>
                                    <div className="space-y-2">
                                        <label htmlFor="email" className="text-sm font-semibold text-gray-700 uppercase tracking-wider">Email</label>
                                        <Input id="email" type="email" placeholder="john@example.com" required className="bg-white border-gray-200 focus:border-black h-12 rounded-xl transition-all" />
                                    </div>
                                </div>

                                <div className="space-y-2">
                                    <label htmlFor="subject" className="text-sm font-semibold text-gray-700 uppercase tracking-wider">Subject</label>
                                    <Input id="subject" placeholder="Project Inquiry" required className="bg-white border-gray-200 focus:border-black h-12 rounded-xl transition-all" />
                                </div>
                                ...
                                <Button type="submit" className="w-full h-14 text-lg font-medium text-white bg-black hover:bg-gray-800 rounded-xl transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2 group">
                                    Send Message
