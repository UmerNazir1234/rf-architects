...
const page = () => {
    const team = [
        { img: "/beautifully-decorated-living-room-interior.jpg", name: "John Doe", role: "Principal Architect" },
        { img: "/ceramic-top-dining-table.jpg", name: "Jane Smith", role: "Interior Designer" },
        { img: "/concrete-modern-dining-table.jpg", name: "Michael Brown", role: "Project Manager" },
        { img: "/elegant-wooden-bookshelf-with-decor.jpg", name: "Emily Davis", role: "Landscape Architect" },
        { img: "/glass-top-dining-table.jpg", name: "David Wilson", role: "Senior Architect" },
    ];
            ...
            <main className="pt-0">
                ...
                <section className="relative h-[60vh] min-h-[500px] flex items-end pb-20 max-sm:pb-8 justify-end bg-black text-white overflow-hidden">
                    ...
                    <div className="relative z-10 container mx-auto px-6 text-center">
                        ...
                        >
                            We believe architecture is more than just buildings; it is about creating environments that elevate the human experience.
                        </motion.p>
                    </div>
                </section>
